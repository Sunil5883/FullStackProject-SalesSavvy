...
FilterChain chain) 
    ...
    if (httpRequest.getMethod().equalsIgnoreCase("OPTIONS")) { 
        setCORSHeaders(httpRequest, httpResponse, chain); 
        return; 
    } 
...
private void setCORSHeaders(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException { 
...
private void sendErrorResponse(HttpServletResponse response, int statusCode, String 
