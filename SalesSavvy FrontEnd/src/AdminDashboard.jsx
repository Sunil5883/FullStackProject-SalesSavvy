...
const AdminDashboard = () => {
  ...
  const handleMonthlyBusiness = async (data) => {
    try {
      const response = await fetch(
        `http://localhost:8080/admin/bussiness/monthly?month=${data?.month}&year=${data?.year}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
  ...
  const handleDailyBusiness = async (data) => {
    try {
      const response = await fetch(
        `http://localhost:8080/admin/bussiness/daily?date=${data?.date}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
  ...
  const handleYearlyBusiness = async (data) => {
    try {
      const response = await fetch(
        `http://localhost:8080/admin/bussiness/yearly?year=${data?.year}`,
        {
          method: "GET",
          credentials: "include",
          headers: {
  ...
  const handleOverallBusiness = async () => {
    try {
      const response = await fetch(
        `http://localhost:8080/admin/bussiness/overAll`,
        {
          method: "GET",
          credentials: "include",
          headers: {
